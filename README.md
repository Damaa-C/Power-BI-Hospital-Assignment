...
### Bar Chart (Department vs Pharmacy Revenue/Cost)
...
The bar chart highlights which drug categories contribute the largest share of pharmacy costs. A small number of categories account for most of the spending, suggesting that certain treatments dominate the pharmacy budget.
...
### Matrix Chart (Total Visits vs Total Pharmacy Revenue)

The matrixplot shows a general upward trend between visits and pharmacy revenue, but the points are not evenly aligned. Some departments generate high revenue with relatively fewer visits, while others have many visits but lower revenue.
...
### Scatter Chart (Average Length of Stay & Pharmacy Cost by Diagnosis)
